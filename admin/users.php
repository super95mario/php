<?php 
	...
	if (isset($_POST['edit']) && $_POST['_action_'] == 'TRUE') {
		$query  = "UPDATE users SET firstname='" . $_POST['firstname'] . "', lastname='" . $_POST['lastname'] . "', email='" . $_POST['email'] . "', username='" . $_POST['username'] . "', country='" . $_POST['country'] . "', roles='" . $_POST['roles'] . "', archive='" . $_POST['archive'] . "'";
	...
	if (isset($_GET['id']) && $_GET['id'] != '') {
		...
		$_query .= " WHERE code='" . $row['roles'] . "'";
		$_result = @mysqli_query($MySQL, $_query);
		$_row = @mysqli_fetch_array($_result);
		print '
		<p><b>roles:</b> ' .$_row['name'] . '</p>
		...
		<form action="" id="registration_form" name="registration_form" method="POST">
			...
			<select name="roles" id="roles">
				...
				while($_row = @mysqli_fetch_array($_result)) {
					...
					if ($row['roles'] == $_row['code']) { print ' selected'; }
